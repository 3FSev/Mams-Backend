...
export default function Main() {
  ...
  return (
    <Container maxWidth={false}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth variant="outlined">
                <TextField id="department" label="Department" variant="outlined" fullWidth />
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth variant="outlined">
                <TextField id="course-group" label="Course Group" variant="outlined" fullWidth />
              </FormControl>
            </Grid>
      ...
      {/* Data Table Section */}
      <CollapsibleCard title="Course" defaultOpen={true}>
